...
Релиз 05.11.2022:
 ...
 - Добавлена возможность добавления пользовательской строки инициализации для драйвера ESP. Можно добавить подключение к АP, нужно добавить в файл auth.p строку  подключения (AT+CWJAP="SSID","drowssap"<0D><0A>)
...
*По умолчанию строка подключения к AP  установлена как "AT". При необходимости заменить ее на актуальную. Для ESP32 "AT+CWJAP=" нужно устаноыить только 1 раз, после ESP32 запомнит точку, для ESP8266 следует использовать "AT+CWJAP_DEF=".


 - MR-TR-AU-64.TRD Версия под TR-DOS, ATM-UART, 64 колонки стандарт
 - MR-TR-EU-64.TRD Версия под TR-DOS, EVO-UART, 64 колонки стандарт
 - MR-TR-AY-64.TRD Версия под TR-DOS, AY-UART , 64 колонки стандарт
 - MR-TR-AY-80.TRD Версия под TR-DOS, AY-UART , 80 колонок TIMEX
 - MR-TR-UN-64.TRD Версия под TR-DOS, UNO-UART, 64 колонки стандарт
 - MR-TR-ZW-64.TRD Версия под TR-DOS, ZXW-UART, 64 колонки стандарт
