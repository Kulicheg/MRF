Релиз 04.02.2023 версия 1.7.2:
 - Для скачивания файлов(не образов на дискету) и для загрузки mod в GS добавлена отображение пульсирующей "*" для отображение "живости" процесса
 - Для драйвера NEDONET увкличен буфер приема, чуть возросла скорость.
